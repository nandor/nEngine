...
namespace nEngine {	
	...
	{			
		...
		glBegin(GL_QUADS);
			glTexCoord2f(0.0f, 0.0f); glVertex2i (0, -img->getHeight());
			glTexCoord2f(1.0f, 0.0f); glVertex2i (img->getWidth() / mFrames, -img->getHeight());
			glTexCoord2f(1.0f, 1.0f); glVertex2i (img->getWidth() / mFrames, 0);
